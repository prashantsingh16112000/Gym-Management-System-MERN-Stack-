...
const EditWorkoutProgram = () => {
	...
	let form = useForm({
		...
		initialValues: {
			...
			categories: workoutProgram.categories // Assign the categories array from workoutProgram
			...
			<Box sx={{ maxWidth: 300 }} mx="auto">
				...
				>
					...
					<MultiSelect
                        ...
                        data={['Category 1', 'Category 2', 'Category 3']} // Provide your list of categories here
